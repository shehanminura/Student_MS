 ...
 * @author User
 */
public class Loginviewteacher extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Loginviewteacher.class.getName());

    /**
     * Creates new form Loginview
     */
    public Loginviewteacher() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Loginviewteacher().setVisible(true));
    }
